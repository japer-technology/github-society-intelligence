...
first case, I hold up an apple and ask, *What is this?*
We've already seen how such a sight could lead to activating
polynemes for words like
*apple* or *fruit.* In the second case, there is no
apple on the scene, and I ask instead, *What do we call those
round, red, thin-peeled fruits?* Yet this time, too, you end up
with an apple thought. Isn't it remarkable that one
can *recognize* a thing merely from hearing words? What is
...
what's happening in certain other parts of mind.
...
this combination would probably activate one of your *apple*
polynemes. Let's call them *apple-nemes* for short. How
...
memories instead of from the sensory world.

![illustration](images/ch19/19-8.png)

In a limited sense, such an agent could be said to recognize a
certain state of mind or — if we dare to use the phrase
— a certain combination of ideas. In this sense, both physical
...
a second kind of memory — a sort of recognition dictionary of
recognizers to recognize its various states.

 ![illustration](images/ch19/19-9.png)
...
constraints and relationships among the parts of things — for
...
[« Previous](som-19.8.md) | [Contents](contents.md) | [Next »](som-19.10.md)
