...
use a less specific frame that fits most any room at all — a
...
direction-neme idea and divide each surface — for ceiling,
floor, and each of the walls — into zones that correspond to
the nine regions of an interaction-square. A typical wall might then
be represented in this fashion:

 ![illustration](images/ch24/24-4.png)
...
later that
*there was a window toward the left, some shelves high to the
right side of the wall, and a table to the right.* If this
...
way to switch over to another frame — while still retaining
...
interchange those frames, the information stored in them remains.

---

[« Previous](som-24.6.md) | [Contents](contents.md) | [Next »](som-24.8.md)
