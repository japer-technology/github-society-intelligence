...
([12.6](som-12.6.md)) A type of learning based on
collecting examples of an idea without attempting to describe
what they have in common. Contrast
with [Uniframe](#uniframe).

### Agency

([1.6](som-1.6.md)) Any assembly of
...
([7.4](som-7.4.md)) The field of research concerned
...
1966. See [Intelligence](#intelligence).

### Attachment Learning

([17.2](som-17.2.md)) The specific theory, proposed
...
([27.2](som-27.2.md)) An agent that
...
([4.4](som-4.4.md)) A rival of mine, disguised as the
...
([19.10](som-19.10.md)) A technique by which an agency can recall many
details of a memory from being given only a few *cues.*

### Common Sense

([1.5](som-1.5.md)) The mental skills that most people share.
...
consciousness in section [6.1](som-6.1.md) was
adapted from my epilogue to Vernor Vinge's novel *True Names*,
Bluejay Books, New York, 1984.

### Context

([20.2](som-20.2.md)) The effect upon one's state of mind of all the
...
that agency. See [Neme](#neme).

### Cross-Exclusion

([16.4](som-16.4.md)) An arrangement in which each of several agents is
connected so as to inhibit all the others — so that only one of
them can remain active at a time.

### Cross-Realm Correspondence

([29.4](som-29.4.md)) A structure that has useful
...
([7.10](som-7.10.md)) The myth that the production of novel ideas, artistic
...
([8.5](som-8.5.md), [12.12](som-12.12.md))
...
([27.1](som-27.1.md)) An agent that
...
See [Interaction-Square](#interaction-square) and
...
thought. See [Time Blinking](#time-blinking).

### Emotion

([16.1](som-16.1.md)) A term used
...
[Proto-specialist](#proto-specialist).

### Exploitation

([4.5](som-4.5.md)) The act of one agency making use of the activity of
...
([12.9](som-12.9.md)) The concept that it may not pay to change a
...
[Investment Principle](#investment-principle).
...
1975. See [Picture-Frames](#picture-frames), [Trans-frame](#trans-frame).

### Frame-Array

([25.2](som-25.2.md)) A family
...
([12.4](som-12.4.md)) Specifying something in terms
...
([7.10](som-7.10.md)) An individual of
...
([7.8](som-7.8.md)) The representation in a difference-engine of an imagined
...
([5.2](som-5.2.md)) Literally, a tiny person. In psychology, the
...
([14.9](som-14.9.md)) The idea of representing the
...
Principle](#recursion-principle).

### Intelligence

([7.1](som-7.1.md)) A term frequently
...
([6.5](som-6.5.md)) The myth
that our minds possess the ability directly to perceive or
apprehend their own operations.

### Intuition

([12.10](som-12.10.md)) The myth that the mind possesses some immediate (and
...
aging. See [Exception
Principle](#exception-principle).

### Isonome

([22.1](som-22.1.md)) A signal or
pathway in the brain that has similar effects on several
different agencies.

### K-Line

([8.1](som-8.1.md)) The theory that
...
([7.5](som-7.5.md)) An omnibus
word for all the processes that lead to long-term changes in our
minds.

### Level-Band

([8.5](som-8.5.md)) The idea that a typical mental process tends to
...
([19.5](som-19.5.md)) An agent
that can reset an agency into some previously useful state. See
[Recognizer](#recognizer)
and [Distributed Memory](#distributed-memory).

### Memory

([15.3](som-15.3.md)) An omnibus
...
State](#partial-mental-state).

### Metaphor

([29.8](som-29.8.md)) The myth
...
([19.7](som-19.7.md)) A type of recognition machine
...
([24.7](som-24.7.md)) A type of frame whose
...
([19.5](som-19.5.md)) An agent that arouses
...
([21.1](som-21.1.md) ) A type of agent associated with a
...
([16.3](som-16.3.md)) One of the genetically
...
([7.3](som-7.3.md)) The idea that any problem can
...
section [21.7](som-21.7.md) accomplishes this by
...
Fallacy](#single-agent-fallacy).

### Single-Agent Fallacy

([4.1](som-4.1.md)) The idea that a person's
...
([2.4](som-2.4.md)) A situation in which one system
...
([16.8](som-16.8.md)) An illusion that a certain
...
([10.2](som-10.2.md)) The agents used by a mind to
make comparisons of quantities.

### Stage of Development

([16.2](som-16.2.md)) An episode in the growth of a
mind. [Chapter 17](som-17.md) offers several
...
([8.4](som-8.4.md))
See [Mental State](#mental-state).

### Structural Definition

([12.4](som-12.4.md)) Describing something in terms
of the relationships among its parts. Contrast
with [Functional Definition](#functional-definition).

### Suppressor

([27.2](som-27.2.md)) A censorlike agent that works
...
([23.3](som-23.3.md)) Finding differences between
...
([17.10](som-17.10.md)) A term often used, in
