...
How can a hurt be canceled by a kiss? How can an insult *add*
...
communal measure-schemes — let's call them currencies
— that let its people work and trade in harmony, even though
...
apportion the things we have to share.
...
compete for certain limited resources — such as space, time,
and energy — and these, to a rather large extent, are
...
food or time — because it takes time to find food, and each
...
our *wealth* as though it were a genuine commodity, a real
substance that we can use, save, lend, or waste.

In a similar way, a group of agencies inside the brain could exploit
some *amount* to keep account of their transactions with one
...
concerns. But if agents had to *pay their way,* what might
...
simply
*computed.* I suspect that what we call the pleasure of
...
it's useful to treat pleasure as equivalent to wealth.

---

[« Previous](som-28.1.md) | [Contents](contents.md) | [Next »](som-28.3.md)
