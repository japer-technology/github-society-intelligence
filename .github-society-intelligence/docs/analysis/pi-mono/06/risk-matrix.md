...
| ID | Risk | Likelihood | Impact | Severity | Mitigation |
|---|---|---|---|---|---|
| ID-06 | API key exposure via browser dev tools or network inspection | Low | High | **High** | All calls are direct browser-to-LLM; keys are not sent to GSI infrastructure. Document this clearly |
...
*Risk assessment based on GSI's deployment context (GitHub Actions, single-maintainer, early-stage, "GitHub as Infrastructure" philosophy) as of 2026-03-30. Revised to account for the accessibility cost of remaining invisible to non-developer audiences.*
