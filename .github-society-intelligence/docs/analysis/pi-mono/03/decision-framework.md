...
*Framework derived from the analysis in [analysis.md](analysis.md) and [risk-matrix.md](risk-matrix.md). Applies to GSI's pi extension ecosystem as of 2026-03-30.*
