...
`.github-society-intelligence/GOVERNANCE.md` — sibling to `AGENTS.md`, at the intelligence root level.
...
**File**: `install/SOCIETY-INTELLIGENCE-AGENTS.md`
...
If `.github-society-intelligence/.pi/BOOTSTRAP.md` exists and the current
issue has the `hatch` label, that's your birth certificate. Read it and
follow it. Figure out who you are.

## Every Session

Read `.github-society-intelligence/AGENTS.md` first — that's who you are.

Read `.github-society-intelligence/GOVERNANCE.md` next — those are the
...
* `/.github-society-intelligence/state/user.md`
  Record their name, how they want to be addressed, and any important notes

Then read `.github-society-intelligence/GOVERNANCE.md` and
`.github-society-intelligence/.pi/APPEND_SYSTEM.md` together and continue
...
.github-society-intelligence/GOVERNANCE.md @<repo-admin-or-team>
```
...
```
.github-society-intelligence/docs/security-assessment.md @<repo-admin>
.github-society-intelligence/docs/final-warning.md @<repo-admin>
```
...
**File**: `.github/workflows/github-society-intelligence-agent.yml`
...
**File**: `install/SOCIETY-INTELLIGENCE-GOVERNANCE.md` (new)

Create a default governance template that ships with fresh installations, similar to how `install/SOCIETY-INTELLIGENCE-AGENTS.md` provides the default `AGENTS.md`. The installer should copy this to `GOVERNANCE.md` on fresh install if `GOVERNANCE.md` does not already exist.

The install step in the workflow (approximate line 227) should add:

```bash
cp "$TARGET/install/SOCIETY-INTELLIGENCE-GOVERNANCE.md" "$TARGET/GOVERNANCE.md"
```
...
The repository hosts three intelligences: GSI, Agenticana, and OpenClaw. Each has its own `AGENTS.md`. If this separation is adopted for GSI, the pattern should be documented as a convention for the others but does not need to be implemented simultaneously.

| Intelligence | Current State | Action |
|---|---|---|
| GSI (`.github-society-intelligence/`) | `AGENTS.md` + `APPEND_SYSTEM.md` | Primary target of this change |
...
5. **Create install template** (`install/SOCIETY-INTELLIGENCE-GOVERNANCE.md`) — supports fresh installations
...
*Implementation outline derived from [Toulmin Lessons §7](toulmin-lessons.md) and codebase analysis of [GitHub Society Intelligence](https://github.com/japer-technology/github-society-intelligence)*
