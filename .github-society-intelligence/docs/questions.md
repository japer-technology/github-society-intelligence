...
Six foundational questions define GitHub Society Intelligence. Each examines the project from a different angle—together they form a complete picture of what repository-native intelligence means and why it matters.

| Question | Summary |
|----------|---------|
| [What?](question-what.md) | Defines GitHub Society Intelligence as a repository-native AI collaboration framework—not a hosted platform, but a local intelligence layer built from issues, workflows, markdown, and commits. |
