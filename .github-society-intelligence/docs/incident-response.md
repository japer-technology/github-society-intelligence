...
This document provides precise, step-by-step procedures for **taking control** of a security incident involving the `github-society-intelligence` (GSI) agent. It covers containment, manual file deletion of compromised artifacts, disabling the workflow agent, and stopping any existing GitHub Actions runs.
...
gh workflow disable "github-society-intelligence-agent.yml"
```

> **Verification:** Confirm under **Actions → github-society-intelligence-agent** that the badge reads "This workflow is disabled" and no runs are in progress.
...
find .github-society-intelligence -type f -newer security-assessment.md -ls
```
...
git rm -r .github-society-intelligence/state/sessions/*
git rm -r .github-society-intelligence/state/issues/*
...
diff .github/workflows/github-society-intelligence-agent.yml \
     .github-society-intelligence/install/github-society-intelligence-agent.yml
```
...
git diff HEAD~20 -- .github-society-intelligence/lifecycle/
git diff HEAD~20 -- .github-society-intelligence/.pi/
```
...
gh workflow enable "github-society-intelligence-agent.yml"
```
