...
> Comprehensive guide to all GitHub Society Intelligence documentation.
>
...
|----------|----------|--------------|
| **What?** | [question-what.md](./question-what.md) | What is GitHub Society Intelligence? A repository-native AI collaboration framework. |
...
|----------|----------|-------------|
| [AGENTS.md](../AGENTS.md) | `.github-society-intelligence/` | Agent identity — name, personality, and behavioral guidance. |
| [PACKAGES.md](../PACKAGES.md) | `.github-society-intelligence/` | Runtime dependencies and required packages. |
