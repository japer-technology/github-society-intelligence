/**
 * local-chat.ts — Local, GitHub-free runner for the Society Intelligence agent.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * PURPOSE
 * ─────────────────────────────────────────────────────────────────────────────
...
const memoryLogPath = resolve(societyIntelligenceDir, "memory.log");
...
function getRepoRoot(): string {
  try {
    ...
    return resolve(societyIntelligenceDir, "..");
  }
}
...
function printCliHelp(): void {
  console.log(
`GitHub Society Intelligence — Local Chat
...
async function interactiveStart(provider: string, model: string, thinking: string | undefined): Promise<Thread | null> {
  ...
  console.log("");
  console.log("  " + c.cyan("┌─────────────────────────────────────────────────────────────────────┐"));
  console.log("  " + c.cyan("│  ") + c.bold("GitHub Society Intelligence") + c.dim(" — Local Chat") + "                           " + c.cyan("│"));
  console.log("  " + c.cyan("└─────────────────────────────────────────────────────────────────────┘"));
  console.log("");
...
function locatePiBin(): string {
  const base = resolve(societyIntelligenceDir, "node_modules", ".bin", "pi");
  ...
  throw new Error(
    ...
    `Run "bun install" inside .github-society-intelligence/ first.`
  );
}
...
async function repl(initial: Thread, rt: RuntimeState): Promise<void> {
  ...
  const sessionStatus = current.sessionPath
    ...
    : "new session";
  console.log("");
  console.log("  " + c.bold("GitHub Society Intelligence") + c.dim(" — Local Chat"));
...
function guidePiNotInstalled(triedPaths: string[]): void {
  say.error(
    ...
    "which is added when you run `bun install` in the .github-society-intelligence/ folder."
  );
  console.log("    " + c.bold("To fix:"));
  console.log("      " + c.gray("cd .github-society-intelligence"));
