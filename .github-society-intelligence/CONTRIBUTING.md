# Contributing to GitHub Society Intelligence
...
3. Test locally with `cd .github-society-intelligence && bun install` and verify dependencies install cleanly.
...
```
.github-society-intelligence/       # Core agent framework
...
3. Install dependencies:
   ```bash
   cd .github-society-intelligence && bun install
   ```
...
- **Skills** are self-contained Markdown files in `.github-society-intelligence/.pi/skills/`.
